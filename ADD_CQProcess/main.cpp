...
//
//
//	CountOperator* cq1 = new CountOperator(300L, "car2");
//	cq1->setTimeWindow(0, 6000);
//	Condition* condition1 = new Condition();
//	condition1->rectangleRegion(30, 30, 60, 60);
//	cq1->setCondition(condition1);
//	queryManager.addEventTriggerQuery(cq1->getTopic(), cq1);
//	
//
...
//int main() {
//	Queries::countBySpeed("car1", 10, 40);
//	Queries::countByMultiCondition("car2", 3000, 3)->setElevationCondition(10, 50);
//
//	startGenerateEvent();
//	Queries::start();
//
